# P040: Update CHANGELOG.md with v0.1.0 release notes

**Date:** 3 April 2026
**Commit:** "P040: Update CHANGELOG.md with v0.1.0 release notes"
**Tests:** 162 passed

## Prompt Summary

Update CHANGELOG.md with comprehensive v0.1.0 release notes covering P001-P039. 8 sections: Core Platform, Text Processing, Visualization, Export, User Experience, Safeguards, Infrastructure, Development.
...
Update CHANGELOG.md with comprehensive v0.1.0 release notes covering

P001-P039. Replace the current "Unreleased" section with a proper
...
- 6-module architecture: config, preprocessing, modelling, file_io,
visualisation, app

- 5 language support (Italian, English, French, German, Spanish) via
spaCy

- 7 analysis tabs: Overview, Topics, Topic Map, Heatmap, Distribution,
...
- POS filtering with presets (Content words, Content+verbs, All open,
Custom)
...
- Welcome screen with 3-step guide and "What is topic modeling?"
explainer
...
CHANGELOG.md updated with comprehensive v0.1.0 release notes.
